    ...
    <x-auth-card>
        ...
        <!-- Name -->
            ...
            <div class="mt-4">
                ...
                <x-input id="adress" class="block mt-1 w-full" type="text" name="adress" :value="old('adress')"
                         required/>
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="fnac" class="block mt-1 w-full" type="date" name="fnac" min='1900-01-01' max='2020-12-31'
                         :value="old('fnac')" required/>
            </div>
