                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table class="min-w-full border-collapse block md:table">
                        ...
                        <tr class="border border-grey-500 md:border-none block md:table-row absolute -top-full md:top-auto -left-full md:left-auto  md:relative ">
                            ...
                            <th class="bg-gray-600 p-2 text-white font-bold md:border md:border-grey-500 text-left block md:table-cell">Marca </th>
                            <th class="bg-gray-600 p-2 text-white font-bold md:border md:border-grey-500 text-left block md:table-cell">Modelo</th>
                        ...
                        <tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
                            <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell">{{$car->matricula}}</td>
                            <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell">{{$car->marca}}</td>
                            <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell">{{$car->modelo}}</td>
                            <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell content-start align-content: space-between;">
                                <a class="" href="{{route('car.show',$car->id)}}">
